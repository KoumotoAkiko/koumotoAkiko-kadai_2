...
return [
    ...
    */
    ...
    'features' => [
        ...
        Features::twoFactorAuthentication([ //二要素認証（２FA)
            'confirm' => true,
    ...
    'paths' => [
    'register' => '/admin/register', //デフォルトはregisterなので/admin/registerに変更
    'login' => '/admin/login', //上に同じくログインした時のルートを/admin/loginに変更
],
